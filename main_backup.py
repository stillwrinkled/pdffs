...
import os
from utils import pdf_operations, file_conversions_backup
...
def split():
    if request.method == 'POST':
        ...
        if file:
            # Call the split function based on the user's choice
            ...
            # If only one file is returned, download it as a PDF
